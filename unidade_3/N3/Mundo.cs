...
namespace gcgcg
{
  class Mundo : GameWindow
  {
    ...
    private ObjetoGeometria objetoAlterar = null;
    private bool bAlterarVerticeSelecionado = false;
#if CG_Privado
    ...
    protected override void OnLoad(EventArgs e)
    {
      ...
      objetoNovo.PontosAdicionar(new Ponto4D(219,300));
      objetoNovo.PontosAdicionar(new Ponto4D(107,490));
      objetoNovo.PontosAdicionar(new Ponto4D(512,495));
      objetoNovo.PontosAdicionar(new Ponto4D(450,216));
      objetoNovo.ObjetoCor.CorR = 255; objetoNovo.ObjetoCor.CorG = 255; objetoNovo.ObjetoCor.CorB = 255;
    ...
    protected override void OnKeyDown(OpenTK.Input.KeyboardKeyEventArgs e)
    {
      ...
      else if (objetoSelecionado != null)
      {
        ...
        {
          if(objetoSelecionado.PontosSelecionado() != null)
          {
            bAlterarVerticeSelecionado = true;
          }
        }
        else if (e.Key == Key.D)
        {
          if(objetoSelecionado.PontosSelecionado() != null)
          {
            objetoAlterar.PontosRemoverSelecionado();
            objetoAlterar = null;
          }
        }
        else if (e.Key == Key.R)
    ...
    protected override void OnMouseMove(MouseMoveEventArgs e)
    {
      ...
      else if (objetoAlterar != null && bAlterarVerticeSelecionado)
      {
        objetoAlterar.PontosSelecionado().X = mouseX;
        objetoAlterar.PontosSelecionado().Y = mouseY;
      }
    }
    ...
    protected override void OnMouseDown(MouseButtonEventArgs e)
    {
      ...
      if(objetoSelecionado != null && objetoAlterar == null)
      {
        objetoSelecionado.selecionarPonto(mouseX, mouseY);
        objetoAlterar = objetoSelecionado;
      } else if (objetoAlterar != null && bAlterarVerticeSelecionado){
        bAlterarVerticeSelecionado = false;
        objetoAlterar.PontosLimparSelecionado();
        objetoAlterar = null;
      }
    }
